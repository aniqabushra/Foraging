...
public class View {
    ...
    public void displayForagers(List<Forager> foragers){
        ...
        for (Forager forager : foragers) {
            io.printf("%s: %s, %s, %.2f $/kg%n", forager.getId(), forager.getFirstName(), forager.getLastName(), forager.getState());
        }
    }
    ...
    public Forager makeForager() {
        ...
        forager.setFirstName(io.readRequiredString("Forager Name: "));
